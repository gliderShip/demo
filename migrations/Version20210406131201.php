 ...
 */
final class Version20210406131201 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__facebook_user AS SELECT id, country_leak, mobile, facebook_id, first_name, last_name, sex, current_district, current_country, current_state, hometown_district, hometown_country, hometown_state, relationship_status, work_company, date10, email, birth_date, facebook_current_address, facebook_hometown_address FROM facebook_user');
        $this->addSql('DROP TABLE facebook_user');
        $this->addSql('CREATE TABLE facebook_user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, country_leak VARCHAR(255) NOT NULL COLLATE BINARY, mobile VARCHAR(12) NOT NULL COLLATE BINARY, facebook_id BIGINT NOT NULL, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, sex VARCHAR(1) NOT NULL COLLATE BINARY, current_district VARCHAR(255) DEFAULT NULL COLLATE BINARY, current_country VARCHAR(255) DEFAULT NULL COLLATE BINARY, current_state VARCHAR(255) DEFAULT NULL COLLATE BINARY, hometown_district VARCHAR(255) DEFAULT NULL COLLATE BINARY, hometown_country VARCHAR(255) DEFAULT NULL COLLATE BINARY, hometown_state VARCHAR(255) DEFAULT NULL COLLATE BINARY, relationship_status VARCHAR(63) DEFAULT NULL COLLATE BINARY, work_company VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(63) DEFAULT NULL COLLATE BINARY, birth_date DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , facebook_current_address VARCHAR(255) DEFAULT NULL COLLATE BINARY, facebook_hometown_address VARCHAR(255) DEFAULT NULL COLLATE BINARY, date10 VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO facebook_user (id, country_leak, mobile, facebook_id, first_name, last_name, sex, current_district, current_country, current_state, hometown_district, hometown_country, hometown_state, relationship_status, work_company, date10, email, birth_date, facebook_current_address, facebook_hometown_address) SELECT id, country_leak, mobile, facebook_id, first_name, last_name, sex, current_district, current_country, current_state, hometown_district, hometown_country, hometown_state, relationship_status, work_company, date10, email, birth_date, facebook_current_address, facebook_hometown_address FROM __temp__facebook_user');
        $this->addSql('DROP TABLE __temp__facebook_user');
